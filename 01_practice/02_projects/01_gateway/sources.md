...
-[ ] 大规模C++程序设计
-[ ] 《密码编码学——加密方法的C与C++实现(第二版)》.([德]Michael Welschenbach).[PDF]@ckook
-[ ] 《C语言经典编程282例》
-[ ] [C.程序设计（第8版）]
-[ ] 数据结构(C++语言版)第三版_邓俊辉(jb51.net)
-[ ] 一站式学习C编程+.宋劲.宋劲杉.扫描版
-[ ] 565928+编写高质量代码++改善C程序代码的125个建议.马伟
-[ ] C语言开发入门及项目实战（C语言学习路线图） (1)
-[ ] [C语言深度解剖--解开程序员面试笔试的秘密]
-[ ] 一站式学习C编程+.宋劲.宋劲杉.扫描版
-[ ] 数据结构与算法分析C++描述第三版
-[ ] c++必知必会c++.C.必知必会
-[ ] 嗨翻C语言_13421426(jb51.net)
-[ ] 深入理解c指针(jb51.net)
-[ ] BOOST程序库完全开发指南：深入C%2B%2B“准”标准库++第3版_PDF电子书下载+带书签目录+高清完整版
-[ ] 写给大忙人看的C%2B%2B
-[ ] C+C%2B%2B常用算法手册
-[ ] C%2B%2B并发编程实战%28中文版%29
-[ ] C语言进阶重点、难点与疑点解析_13131567
-[ ] 《C语言常用算法分析》.%28明日科技%29.%5BPDF%5D%40ckook
-[ ] 好学的C.第2版 奥弗兰.扫描版
-[ ] 明解C语言++第3版++入门篇
-[ ] 计算机算法（C%2B%2B语言描述）（第2版）
-[ ] （中文版）C语言编程：一本全面的C语言入门教程 （第3版）
-[ ] C语言解析教程
-[ ] 《C语言设计伴侣》.(陈良乔)
-[ ] C嵌入式编程设计模式
-[ ] 《C语言项目案例分析》. %28明日科技%29.%5BPDF%5D%40ckook
-[ ] [C.编程-从问题分析到程序设计].D.S.Malik.扫描版(jb51.net)
-[ ] 写给大家看的C语言书_入门神器
-[ ] 数据结构(C++语言版)第三版_邓俊辉(jb51.net)
-[ ] 51CTO下载-C算法．第1卷，基础、数据结构、排序和搜索（第三版）jb51.net
-[ ] C语言深度解剖（第2版）解开程序员面试笔试的秘密 PDF电子书下载 带书签目录 完整版
-[ ] C语言嵌入式系统编程教程
-[ ] C++多线程编程实战+%2C姜佑译+%2CP303
-[ ] 《数据结构 C++ 语言描述》.(William Ford).[PDF]@ckook
-[ ] 《测试驱动的嵌入式C语言开发》
...
-[ ] data structure and algorithms in java 4th 
-[ ] 图论与网络流理论
-[ ] 编程原本
-[ ] Datea structures abstraction and design  using java 3nd
...
-[ ] design pattern designed simply
-[ ] 七周七语言：理解多种编程
-[ ] 面向模式的软件体系结构 卷1 模式系统
-[ ] 面向模式的软件体系架构 卷2 
-[ ] 面向模式的软件体系架构 卷3
...
-[ ] 深度实践KVM
-[ ] linux shell从初学到精通
-[ ] Linux服务器架设、性能、优化、集群管理
-[ ] Redis开发运维实践指南
-[ ] 循序渐进linux服务器搭建系统 第2版
-[ ] 高性能Linux服务器构建实战: 运维监控、性能调优与集群应用
-[ ] 精通linux服务器配置管理 检测 应用
-[ ] linux服务器架设指南
-[ ] linuxProb
-[ ] linux企业应用案例精解
-[ ] linux服务器搭建实战详解
...
- [ ] 迟到的2015年终总结 _ Jark's Blog

- [ ] 程序员的职业素养

- [ ] 我在阿里的这两年 _ Jark's Blog
...
-[ ] 计算机是怎样跑起来的
-[ ] 剑指offer名企面试官精讲典型编程题
-[ ] Coding interview solutins manual
-[ ] 代码之髓编程语言核心
